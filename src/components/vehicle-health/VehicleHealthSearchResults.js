...
var VehicleHealthSearchResults = React.createClass({
    showMenu: function() {
      this.refs.menu.show();
    },
    render: function() {
        ...
        <div className="wrapper padding--left--zero">
          ...
          <div className="sporkPage">
            ...
            <Link to={ {pathname: '/vehicle-health', query: {isMember: this.props.location.query.isMember}} }>
                <div className="backToDiscounts txt--sm vr">Back to Vehicle Health</div>
            </Link>
            <div className="sporkPage__header">
              <div className="sporkPage__header--label">Vehicle(s) Health</div>
            </div>
            <div>
              <img src="images/vehicle-health-search-results.png" />
            </div>
          </div>
        </div>
      )
...
export default VehicleHealthSearchResults 