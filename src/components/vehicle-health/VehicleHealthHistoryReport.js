...
var VehicleHealthHistoryReport = React.createClass({
    showMenu: function() {
      this.refs.menu.show();
    },
    render: function() {
        ...
        <div className="wrapper padding--left--zero">
          ...
          <div className="sporkPage">
            ...
            <div className="sporkPage__header">
              <div className="sporkPage__header--label">Vehicle History Report</div>
            </div>
            <div>
              <img src="images/vehicle-history-report.png" />
            </div>
            <div>
              <img src="images/vehicle-history-title-and-additional-history.png" />
            </div>
            <div>
              <img src="images/vehicle-history-detailed-history.png" />
            </div>
          </div>
        </div>
      )
...
export default VehicleHealthHistoryReport 