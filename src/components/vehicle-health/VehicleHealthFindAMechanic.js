...
var VehicleHealthFindAMechanic = React.createClass({
    showMenu: function() {
      this.refs.menu.show();
    },
    render: function() {
        ...
        <div className="wrapper padding--left--zero">
          ...
          <div className="sporkPage">
            ...
            <div className="sporkPage__header">
              <div className="sporkPage__header--label">Find A Mechanic</div>
            </div>
            <div>
              <img src="images/vehicle-health-find-a-mechanic.png" />
            </div>
...
export default VehicleHealthFindAMechanic 