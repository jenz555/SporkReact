...
var RepairFacilities = React.createClass({
    showMenu: function() {
      this.refs.menu.show();
    },
    render: function() {
        ...
        <div className="wrapper padding--left--zero">
          ...
          <div className="sporkPage">
            ...
            <div className="sporkPage__header">
              <div className="sporkPage__header--label">Repair Facilities</div>
            </div>
            <div>
              <img src="images/repair-facilities-find-a-mechanic.png" />
            </div>
          </div>
        </div>
      )
...
export default RepairFacilities